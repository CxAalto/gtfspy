...
NodeProfile = DecreasingDepTimeNodeProfile


class TestNodeProfile(TestCase):

    def test_earliest_arrival_time(self):
        for Profile in (NodeProfile, DecreasingDepTimeNodeProfile):
    ...
    def test_pareto_optimality(self):
        for Profile in (NodeProfile, DecreasingDepTimeNodeProfile):
            pt1 = ParetoTuple(departure_time=10, arrival_time_target=35)
            pt2 = ParetoTuple(departure_time=5, arrival_time_target=35)
            node_profile = Profile()
