...
from gtfspy.routing.label import (
    ...
    merge_pareto_frontiers,
    LabelVehLegCount,
    compute_pareto_front,
    compute_pareto_front_naive,
    LabelTimeAndRoute,
...
class TestLabelTimeAndVehLegCount(TestCase):
    def test_dominates_simple(self):
        label1 = LabelTimeWithBoardingsCount(
            departure_time=0, arrival_time_target=20, n_boardings=0, first_leg_is_walk=False
        )
        label2 = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=10, n_boardings=0, first_leg_is_walk=False
        )
        self.assertTrue(label2.dominates(label1))
    ...
    def test_does_not_dominate_same(self):
        ...
        label3 = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=10, n_boardings=0, first_leg_is_walk=False
        )
        self.assertTrue(label2.dominates(label3))
    ...
    def test_dominates_later_arrival_time(self):
        ...
        label4 = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=11, n_boardings=0, first_leg_is_walk=False
        )
        self.assertTrue(label2.dominates(label4))
    ...
    def test_dominates_earlier_departure_time(self):
        ...
        label5 = LabelTimeWithBoardingsCount(
            departure_time=0, arrival_time_target=10, n_boardings=0, first_leg_is_walk=False
        )
        self.assertTrue(label2.dominates(label5))

    def test_dominates_less_transfers(self):
        labela = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=10, n_boardings=1, first_leg_is_walk=False
        )
        labelb = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=10, n_boardings=0, first_leg_is_walk=False
        )
    ...
    def test_dominates_less_transfers_different_travel_time(self):
        labela = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=9, n_boardings=1, first_leg_is_walk=False
        )
        labelb = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=10, n_boardings=0, first_leg_is_walk=False
        )
    ...
    def test_sort(self):
        l1 = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=1, n_boardings=3, first_leg_is_walk=False
        )
...
class TestLabelTimeAndRoute(TestCase):
    def test_dominates_simple(self):
        label1 = LabelTimeAndRoute(
            departure_time=0, arrival_time_target=20, movement_duration=0, first_leg_is_walk=False
        )
        label2 = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=10, movement_duration=0, first_leg_is_walk=False
        )
        self.assertTrue(label2.dominates(label1))
    ...
    def test_dominates_later_arrival_time(self):
        ...
        label4 = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=11, movement_duration=0, first_leg_is_walk=False
        )
        self.assertTrue(label2.dominates(label4))
    ...
    def test_dominates_earlier_departure_time(self):
        ...
        label5 = LabelTimeAndRoute(
            departure_time=0, arrival_time_target=10, movement_duration=0, first_leg_is_walk=False
        )
        self.assertTrue(label2.dominates(label5))
        self.assertFalse(label5.dominates(label2))

    def test_dominates_less_movement_duration(self):
        labela = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=10, movement_duration=0, first_leg_is_walk=False
        )
        labelb = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=10, movement_duration=1, first_leg_is_walk=False
        )
        self.assertFalse(labelb.dominates(labela))
    ...
    def test_dominates_less_movement_duration_when_arrival_time_not_the_same(self):
        ...
        labela = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=9, movement_duration=1, first_leg_is_walk=False
        )
        labelb = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=10, movement_duration=0, first_leg_is_walk=False
        )
    ...
    def test_dominates_less_movement_duration_when_departure_time_not_the_same(self):
        labela = LabelTimeAndRoute(
            departure_time=4, arrival_time_target=10, movement_duration=1, first_leg_is_walk=False
        )
        labelb = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=10, movement_duration=0, first_leg_is_walk=False
        )
    ...
    def test_duration(self):
        label1 = LabelTimeAndRoute(
            departure_time=0, arrival_time_target=20, movement_duration=1, first_leg_is_walk=False
        )
        self.assertEqual(20, label1.duration())

    def test_sort(self):
        l1 = LabelTimeAndRoute(
            departure_time=1, arrival_time_target=1, movement_duration=3, first_leg_is_walk=False
        )
...
class TestLabelTimeBoardingsAndRoute(TestCase):
    def test_dominates_simple(self):
        label1 = LabelTimeBoardingsAndRoute(
            departure_time=0,
        ...
        label2 = LabelTimeBoardingsAndRoute(
            departure_time=1,
    ...
    def test_does_not_dominate_same(self):
        ...
        label3 = LabelTimeBoardingsAndRoute(
            departure_time=1,
            arrival_time_target=10,
            movement_duration=0,
            n_boardings=1,
    ...
    def test_dominates_later_arrival_time(self):
        ...
        label4 = LabelTimeBoardingsAndRoute(
            departure_time=1,
    ...
    def test_dominates_earlier_departure_time(self):
        ...
        label5 = LabelTimeBoardingsAndRoute(
            departure_time=0,
            arrival_time_target=10,
            movement_duration=0,
            n_boardings=1,
    ...
    def test_dominates_less_movement_duration(self):
        labela = LabelTimeBoardingsAndRoute(
            departure_time=1,
            arrival_time_target=10,
            movement_duration=0,
            n_boardings=1,
        ...
        labelb = LabelTimeBoardingsAndRoute(
            departure_time=1,
            arrival_time_target=10,
            movement_duration=1,
            n_boardings=1,
    ...
    def test_various_dominates(self):
        labela = LabelTimeBoardingsAndRoute(
            departure_time=1481520618,
            arrival_time_target=1481521300,
            n_boardings=1,
            movement_duration=681,
            first_leg_is_walk=True,
        )
        labelb = LabelTimeBoardingsAndRoute(
            departure_time=1481520618,
            arrival_time_target=1481521215,
            n_boardings=1,
            movement_duration=597,
            first_leg_is_walk=True,
        )
        self.assertTrue(labelb.dominates(labela))
        self.assertFalse(labela.dominates(labelb))
...
class TestParetoFrontier(TestCase):
    def test_compute_pareto_front_all_include(self):
        label_a = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=2, n_boardings=0, first_leg_is_walk=False
        )
        label_b = LabelTimeWithBoardingsCount(
            departure_time=2, arrival_time_target=3, n_boardings=0, first_leg_is_walk=False
        )
        label_c = LabelTimeWithBoardingsCount(
            departure_time=3, arrival_time_target=4, n_boardings=0, first_leg_is_walk=False
        )
        label_d = LabelTimeWithBoardingsCount(
            departure_time=4, arrival_time_target=5, n_boardings=0, first_leg_is_walk=False
        )
    ...
    def test_one_dominates_all(self):
        label_a = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=12, n_boardings=0, first_leg_is_walk=False
        )
        label_b = LabelTimeWithBoardingsCount(
            departure_time=2, arrival_time_target=13, n_boardings=0, first_leg_is_walk=False
        )
        label_c = LabelTimeWithBoardingsCount(
            departure_time=3, arrival_time_target=14, n_boardings=0, first_leg_is_walk=False
        )
        label_d = LabelTimeWithBoardingsCount(
            departure_time=4, arrival_time_target=5, n_boardings=0, first_leg_is_walk=False
        )
    ...
    def test_some_are_optimal_some_are_not(self):
        label_a = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=2, n_boardings=1, first_leg_is_walk=False
        )  # optimal
        label_b = LabelTimeWithBoardingsCount(
            departure_time=1, arrival_time_target=5, n_boardings=0, first_leg_is_walk=False
        )  # label_d dominates
        label_c = LabelTimeWithBoardingsCount(
            departure_time=3, arrival_time_target=4, n_boardings=1, first_leg_is_walk=False
        )  # optimal
        label_d = LabelTimeWithBoardingsCount(
            departure_time=4, arrival_time_target=5, n_boardings=0, first_leg_is_walk=False
        )  # optimal
            ...
            for dep_time in range(0, n):
                for n_veh_legs in range(2):
                    for arr_time in range(dep_time, dep_time + 10):
                        label = LabelTimeWithBoardingsCount(
                            dep_time, arr_time - n_veh_legs, n_veh_legs, False
                        )
                        labels.append(label)
            import random
    ...
    def test_compute_pareto_front_smart_randomized(self):
        ...
        for i in range(10):
            labels = [
                LabelTimeWithBoardingsCount(
                    random.randint(0, 1000), random.randint(0, 1000), random.randint(0, 10), 0
                )
                for _ in range(1000)
            ]
