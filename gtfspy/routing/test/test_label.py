...
class TestLabelExperimental(TestCase):

    def test_dominates_simple(self):
        label1 = LabelExperimental(departure_time=0, arrival_time_target=20, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        label2 = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertTrue(label2.dominates(label1))
        self.assertFalse(label1.dominates(label2))
    ...
    def test_does_not_dominate_same(self):
        label2 = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        label3 = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertTrue(label2.dominates(label3))
        self.assertTrue(label3.dominates(label2))
    ...
    def test_dominates_later_arrival_time(self):
        label2 = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        label4 = LabelExperimental(departure_time=1, arrival_time_target=11, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertTrue(label2.dominates(label4))
        self.assertFalse(label4.dominates(label2))
    ...
    def test_dominates_earlier_departure_time(self):
        label2 = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        label5 = LabelExperimental(departure_time=0, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertTrue(label2.dominates(label5))
        self.assertFalse(label5.dominates(label2))

    def test_dominates_less_movement_duration(self):
        labela = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        labelb = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=1, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertFalse(labelb.dominates(labela))
        self.assertTrue(labela.dominates(labelb))
    ...
    def test_dominates_less_movement_duration_when_arrival_time_not_the_same(self):
        # a should dominate b as the travel time is shorter
        labela = LabelExperimental(departure_time=1, arrival_time_target=9, movement_duration=1, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        labelb = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertFalse(labelb.dominates(labela))
        self.assertTrue(labela.dominates(labelb))

    def test_dominates_less_movement_duration_when_departure_time_not_the_same(self):
        labela = LabelExperimental(departure_time=4, arrival_time_target=10, movement_duration=1, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        labelb = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertFalse(labelb.dominates(labela))
    ...
    def test_dominates_walking_duration(self):
        labela = LabelExperimental(departure_time=4, arrival_time_target=10, movement_duration=1, n_boardings=1,
                                   walking_duration=5, first_leg_is_walk=False)
        labelb = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertFalse(labelb.dominates(labela))
        self.assertFalse(labela.dominates(labelb))
    ...
    def test_dominates_ignoring_dep_time_finalization_both_pareto(self):
        labela = LabelExperimental(departure_time=1, arrival_time_target=9, movement_duration=1, n_boardings=1,
                                   walking_duration=0, first_leg_is_walk=False)
        labelb = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=0, n_boardings=0,
                                   walking_duration=0, first_leg_is_walk=False)
        self.assertFalse(labelb.dominates_ignoring_dep_time_finalization(labela))
        self.assertFalse(labela.dominates_ignoring_dep_time_finalization(labelb))
    ...
    def test_dominates_ignoring_boardings(self):
        label_a = LabelExperimental(2.0, 13.0, 2, 1, 1, False)
        label_d = LabelExperimental(2.0, 10.0, 2, 1, 4, False)

        self.assertFalse(label_a.dominates_ignoring_dep_time_and_n_boardings(label_d))
        self.assertTrue(label_d.dominates_ignoring_dep_time_and_n_boardings(label_a))

    def test_various_dominates(self):
        labela = LabelExperimental(departure_time=1481520618, arrival_time_target=1481521300, n_boardings=1,
                                   movement_duration=681, walking_duration=0, first_leg_is_walk=True)
        labelb = LabelExperimental(departure_time=1481520618, arrival_time_target=1481521215, n_boardings=1,
                                   movement_duration=597, walking_duration=0, first_leg_is_walk=True)
        self.assertTrue(labelb.dominates(labela))
        self.assertFalse(labela.dominates(labelb))

    """
    def test_dominates_ignoring_dep_time_finalization_equal(self):
        labela = LabelExperimental(departure_time=11, arrival_time_target=10, movement_duration=1,
                                   first_leg_is_walk=False)
        labelb = LabelExperimental(departure_time=1, arrival_time_target=10, movement_duration=1,
                                   first_leg_is_walk=False)
        self.assertFalse(labelb.dominates_ignoring_dep_time_finalization(labela))
        self.assertFalse(labela.dominates_ignoring_dep_time_finalization(labelb))
    """
    def test_duration(self):
        label1 = LabelExperimental(departure_time=0, arrival_time_target=20, movement_duration=1,
                                   n_boardings=1, walking_duration=0, first_leg_is_walk=False)
        self.assertEqual(20, label1.duration())

    def test_sort(self):
        l1 = LabelExperimental(departure_time=1, arrival_time_target=1, movement_duration=3,
                               n_boardings=1,  walking_duration=0, first_leg_is_walk=False)
        l2 = LabelExperimental(0, 0, 0, 1, 0, False)
        self.assertTrue(l1 > l2)
        self.assertTrue(l1 >= l2)
        self.assertFalse(l1 < l2)
        self.assertFalse(l1 <= l2)

        l1 = LabelExperimental(0, 0, 0, 1, 0, False)
        l2 = LabelExperimental(0, 0, 0, 1, 0, False)
        self.assertTrue(l1 == l2)
        self.assertTrue(l1 >= l2)
        self.assertTrue(l1 <= l2)
        ...
        l1 = LabelExperimental(1, 0, 10, 1, 0, False)
        l2 = LabelExperimental(1, 1, 10, 1, 0, False)
        self.assertTrue(l1 > l2)
        self.assertFalse(l1 < l2)

        l1 = LabelExperimental(1, 1, 0, 1, 0, False)
        l2 = LabelExperimental(1, 1, 10, 1, 0, False)
        self.assertTrue(l1 > l2)
        self.assertFalse(l1 < l2)
        ...
        l1 = LabelExperimental(1, 1, 10, 1, 0, True)
        l2 = LabelExperimental(1, 1, 10, 1, 0, False)
        self.assertTrue(l1 < l2)
        self.assertFalse(l1 > l2)
...
class TestParetoFrontier(TestCase):
    ...
    def test_compute_pareto_front_all_include(self):
        label_a = LabelTimeWithBoardingsCount(departure_time=1, arrival_time_target=2, n_boardings=0,
                                              first_leg_is_walk=False)
        label_b = LabelTimeWithBoardingsCount(departure_time=2, arrival_time_target=3, n_boardings=0,
                                              first_leg_is_walk=False)
        label_c = LabelTimeWithBoardingsCount(departure_time=3, arrival_time_target=4, n_boardings=0,
                                              first_leg_is_walk=False)
        label_d = LabelTimeWithBoardingsCount(departure_time=4, arrival_time_target=5, n_boardings=0,
                                              first_leg_is_walk=False)
        labels = [label_a, label_b, label_c, label_d]
        self.assertEqual(4, len(compute_pareto_front(labels)))

    def test_one_dominates_all(self):
        label_a = LabelTimeWithBoardingsCount(departure_time=1, arrival_time_target=12, n_boardings=0,
                                              first_leg_is_walk=False)
        label_b = LabelTimeWithBoardingsCount(departure_time=2, arrival_time_target=13, n_boardings=0,
                                              first_leg_is_walk=False)
        label_c = LabelTimeWithBoardingsCount(departure_time=3, arrival_time_target=14, n_boardings=0,
                                              first_leg_is_walk=False)
        label_d = LabelTimeWithBoardingsCount(departure_time=4, arrival_time_target=5, n_boardings=0,
                                              first_leg_is_walk=False)
        labels = [label_a, label_b, label_c, label_d]
    ...
    def test_some_are_optimal_some_are_not(self):
        label_a = LabelTimeWithBoardingsCount(departure_time=1, arrival_time_target=2, n_boardings=1,
                                              first_leg_is_walk=False)  # optimal
        label_b = LabelTimeWithBoardingsCount(departure_time=1, arrival_time_target=5, n_boardings=0,
                                              first_leg_is_walk=False)  # label_d dominates
        label_c = LabelTimeWithBoardingsCount(departure_time=3, arrival_time_target=4, n_boardings=1,
                                              first_leg_is_walk=False)  # optimal
        label_d = LabelTimeWithBoardingsCount(departure_time=4, arrival_time_target=5, n_boardings=0,
                                              first_leg_is_walk=False)  # optimal
        labels = [label_a, label_b, label_c, label_d]
    ...
    def test_compute_pareto_front_smart_randomized(self):
        ...
        for i in range(10):
            labels = [
                LabelTimeWithBoardingsCount(random.randint(0, 1000), random.randint(0, 1000), random.randint(0, 10), 0)
                for _ in range(1000)]
