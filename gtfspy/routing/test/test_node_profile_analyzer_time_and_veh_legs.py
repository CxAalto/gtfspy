...
class TestNodeProfileAnalyzerTimeAndVehLegs(TestCase):
    ...
    def test_temporal_distances_by_n_vehicles(self):
        labels = [
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=12, n_boardings=4, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=15, n_boardings=2, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=17, n_boardings=1, first_leg_is_walk=False
            ),
        ]
    ...
    def test_n_boardings_on_shortest_paths(self):
        labels = [
            ...
            LabelTimeWithBoardingsCount(
                departure_time=5, arrival_time_target=10, n_boardings=2, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=5, arrival_time_target=12, n_boardings=0, first_leg_is_walk=False
            ),
        ]
        analyzer = self._get_analyzer(labels, 0, 10, walk_to_target_duration=10)
    ...
    def test_min_n_boardings(self):
        labels = [
            ...
            LabelTimeWithBoardingsCount(
                departure_time=5, arrival_time_target=12, n_boardings=1, first_leg_is_walk=False
            ),
        ]
        analyzer = self._get_analyzer(labels, 0, 10, walk_to_target_duration=10)
    ...
    def test_min_n_boardings_after_departure_time_2(self):
        ...
        labels = [
            LabelTimeWithBoardingsCount(
                departure_time=12, arrival_time_target=14, n_boardings=2, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=11, arrival_time_target=12, n_boardings=3, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=5, arrival_time_target=10, n_boardings=4, first_leg_is_walk=False
            ),
        ]
    ...
    def test_min_n_boardings_on_fastest_paths(self):
        labels = [
            LabelTimeWithBoardingsCount(
                departure_time=5, arrival_time_target=12, n_boardings=4, first_leg_is_walk=False
            ),
        ]
        analyzer = self._get_analyzer(labels, 0, 10, walk_to_target_duration=10)
    ...
    def test_mean_n_boardings_on_fastest_paths(self):
        labels = [
            LabelTimeWithBoardingsCount(
                departure_time=5, arrival_time_target=6, n_boardings=1, first_leg_is_walk=False
            ),
        ]
        analyzer = self._get_analyzer(labels, 0, 10, walk_to_target_duration=10)
        ...
        labels = [
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=15, n_boardings=1, first_leg_is_walk=False
            ),
        ]
        analyzer = self._get_analyzer(labels, 0, 10, walk_to_target_duration=10)
        self.assertEqual(analyzer.mean_n_boardings_on_shortest_paths(), 0.5)
    ...
    def test_mean_temporal_distance_with_min_n_boardings(self):
        labels = [
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=22, n_boardings=4, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=24, n_boardings=2, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=26, n_boardings=1, first_leg_is_walk=False
            ),
        ]
    ...
    def test_n_boardings_on_fastest_trip(self):
        ...
        analyzer = self._get_analyzer(
            labels, start_time=0, end_time=11, walk_to_target_duration=float("inf")
        )
    ...
    def test_plot(self):
        labels = [
            LabelTimeWithBoardingsCount(
                departure_time=20, arrival_time_target=22, n_boardings=5, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=15, arrival_time_target=20, n_boardings=6, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=14, arrival_time_target=21, n_boardings=5, first_leg_is_walk=False
            ),
            LabelTimeWithBoardingsCount(
                departure_time=13, arrival_time_target=22, n_boardings=4, first_leg_is_walk=False
            ),
            # LabelTimeWithBoardingsCount(departure_time=12, arrival_time_target=23, n_vehicle_legs=3),
            LabelTimeWithBoardingsCount(
                departure_time=11, arrival_time_target=24, n_boardings=2, first_leg_is_walk=True
            ),
            LabelTimeWithBoardingsCount(
                departure_time=10, arrival_time_target=25, n_boardings=1, first_leg_is_walk=True
            ),
            LabelTimeWithBoardingsCount(
