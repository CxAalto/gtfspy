...
class TestNodeProfileSimple(TestCase):
    ...
    def test_pareto_optimality(self):
        ...
        self.assertEquals(
            2, len(node_profile._labels), msg=str(node_profile.get_final_optimal_labels())
        )
    ...
    def test_pareto_optimality_with_transfers(self):
        ...
        pt3 = LabelTimeWithBoardingsCount(
            departure_time=5, arrival_time_target=35, n_boardings=0, first_leg_is_walk=True
        )
        pt2 = LabelTimeWithBoardingsCount(
            departure_time=5, arrival_time_target=35, n_boardings=1, first_leg_is_walk=True
        )
        pt1 = LabelTimeWithBoardingsCount(
            departure_time=5, arrival_time_target=35, n_boardings=2, first_leg_is_walk=True
        )
