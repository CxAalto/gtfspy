...
class TestJourneyData(TestCase):
    ...
    def _import_sample_gtfs_db(self):
        import_gtfs(
            [os.path.join(os.path.dirname(__file__), "../../test/test_data/test_gtfs.zip")],
            self.gtfs_path,
        )
    ...
    def setUp(self):
        ...
        self.data_store_path = os.path.join(
            self.routing_tmp_test_data_dir, "test_data_store.sqlite"
        )
