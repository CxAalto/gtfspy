...
class StatsTest(unittest.TestCase):
    ...
    def test_get_median_lat_lon_of_stops(self):
        ...
        self.assertTrue(
            lat != lon,
            "probably median lat and median lon should not be equal for any real data set",
        )
    ...
    def test_get_centroid_of_stops(self):
        ...
        self.assertTrue(
            lat != lon, "probably centroid lat and lon should not be equal for any real data set"
        )
        self.assertTrue(isinstance(lat, float))
        self.assertTrue(isinstance(lon, float))
