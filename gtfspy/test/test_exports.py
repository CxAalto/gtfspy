...
class ExportsTest(unittest.TestCase):
    ...
    def test_walk_network(self):
        ...
        threshold = 670
        walk_net = networks.walk_transfer_stop_to_stop_network(
            self.gtfs, max_link_distance=threshold
        )
    ...
    def test_stop_to_stop_network_by_route_type(self):
        ...
        nxGraph = networks.stop_to_stop_network_for_route_type(
            self.gtfs, BUS, link_attributes=ALL_STOP_TO_STOP_LINK_ATTRIBUTES
        )
        ...
        for from_I, to_I, linkData in edges:
            ...
            self.assertTrue(
                isinstance(ds, int) or (ds is None),
    ...
    def test_write_gtfs_agencies(self):
        ...
        self.__test_write_gtfs_table(
            exports._write_gtfs_agencies, required_columns, optional_columns
        )
    ...
    def test_write_gtfs_stop_times(self):
        ...
        self.__test_write_gtfs_table(
            exports._write_gtfs_stop_times, required_columns, optional_columns
        )
    ...
    def test_write_gtfs_transfers(self):
        ...
        self.__test_write_gtfs_table(
            exports._write_gtfs_transfers, required_columns, optional_columns
        )
    ...
    def test_write_gtfs_stop_distances(self):
        ...
        optional_columns = []
        self.__test_write_gtfs_table(
            exports._write_gtfs_stop_distances, required_columns, optional_columns
        )
    ...
    def test_write_feed_info(self):
        ...
        self.__test_write_gtfs_table(
            exports._write_gtfs_feed_info, required_columns, columns_not_present
        )
