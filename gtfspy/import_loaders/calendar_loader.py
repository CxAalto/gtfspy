from .table_loader import TableLoader, decode_six
...
class CalendarLoader(TableLoader):
    ...
    copy_where = (
        "WHERE  date({start_ut}, 'unixepoch', 'localtime') < end_date "
    ...
    def index(cls, cur):
        ...
        cur.execute(
            "CREATE INDEX IF NOT EXISTS idx_calendar_s_e ON calendar (start_date, end_date)"
        )
